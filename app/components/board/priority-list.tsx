  ...
  return (
    <div className="mb-6">
      ...
      <ul className="flex flex-col gap-y-2">
        {priority.map((list) => (
          <li key={list.value} className={`relative pl-5 before:absolute before:w-2.5 before:h-2.5 before:rounded-full before:top-2/4 before:left-0 before:translate-y-[-50%] ${list.color}`}>
